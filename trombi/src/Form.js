...
class Form extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        // myLog("Form.js componentDidUpdate")
    }
    ...
    handleChange = (event) => {
        ...
        myLog("Form.js - handleChange:" + this.state);
        // méthode pour que l'état soit pris en compte immédiatement
            ...
            <div className="col-lg-6 offset-lg-3 p-3 formCustom">
                <form>
                    ...
                    <div className="col-md-12 text-center pt-3">
                        <button type="reset" className="btn btn-danger" onClick={this.handleCancel}>Réinitialiser
                        </button>
                    </div>
